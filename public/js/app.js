...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_image_crop_upload__ = __webpack_require__(51);
...
Vue.component('login-component', __webpack_require__(11));
Vue.component('signup-component', __webpack_require__(14));
Vue.component('properties-component', __webpack_require__(17));
Vue.component('filters-component', __webpack_require__(20));
...
Vue.component('report-component', __webpack_require__(30));
Vue.component('success-component', __webpack_require__(33));
Vue.component('mapview-component', __webpack_require__(36));
Vue.component('forgot-password-component', __webpack_require__(39));
var app = new Vue({
    el: '#app',
    data: function data() {
        return {
    ...
    methods: {
        ...
        mapDialog: function (_mapDialog) {
            ...
            mapDialog.showModal();
            setTimeout(function () {
                var lat = parseFloat(_this.$children[2]._props.propertylat);
                var long = parseFloat(_this.$children[2]._props.propertylong);
                ...
                _c("input", {
                  ...
                  on: {
                    input: function($event) {
                      ...
                      _vm.$set(_vm.FormData, "priceFrom", $event.target.value)
                    }
                  }
                }),
                _vm._v(" "),
                ...
                _c("input", {
                  ...
                  on: {
                    input: function($event) {
                      ...
                      _vm.$set(_vm.FormData, "priceTo", $event.target.value)
                    }
                  }
                }),
                _vm._v(" "),
...
var update = __webpack_require__(54)("4d3b2a1c", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../css-loader/index.js!../vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-25292217\",\"scoped\":false,\"hasInlineConfig\":true}!../vue-loader/lib/selector.js?type=styles&index=0&bustCache!./upload-2.vue", function() {
     var newContent = require("!!../css-loader/index.js!../vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-25292217\",\"scoped\":false,\"hasInlineConfig\":true}!../vue-loader/lib/selector.js?type=styles&index=0&bustCache!./upload-2.vue");
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_language_js__ = __webpack_require__(57);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_mimes_js__ = __webpack_require__(58);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_data2blob_js__ = __webpack_require__(59);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_effectRipple_js__ = __webpack_require__(60);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["a"] = ({
	...
	ar:{
		hint: 'أسحب الصورة هنا للإضافة أو اضغط',
		loading: 'جاري الرفع....',
		noSupported: 'Browser is not supported, please use IE10+ or other browsers',
		success: 'تم تغير الصورة بنجاح',
		fail: 'Upload failed',
		preview: 'عرض',
		btn: {
			off: 'ألغاء',
		...
		error: {
			onlyImg: 'صور فقط',
			outOfSize: 'الصور تجاوزت الحجم المسموح به',
			lowestPx: 'Image\'s size is too low. Expected at least: '
		}
	},
	ro: {
