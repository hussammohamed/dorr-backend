...
<div class="content content-padding">
    <div class="group-ad">
        ...
        <form id="example-form" class="wizard-form" action="#">
            ...
            <div class="mdl-card mdl-shadow--2dp u-full-width u-mbuttom30">
            ...
            <div class="u-center">
                    ...
                    <button type="button" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised mdl-button--colored u-center">حفظ التغيرات</button>
              </div>
        </form>
    </div>
