...
class Contract extends Model
{
    ...
    protected $casts = [
        ...
        'owner_nationality' => 'integer',
        'owner_id_type' => 'integer',
        'renter_user_id' => 'integer',
        'renter_nationality' => 'integer',
        'renter_id_type' => 'integer',
        'agency_id' => 'integer',
        'agent_user_id' => 'integer',
        'agent_nationality' => 'integer',
        'agent_id_type' => 'integer',
        'property_instrument_no' => 'integer',
        'property_instrument_issuer' => 'integer',
        'property_instrument_place' => 'integer',
        'm_property_id' => 'integer',
        'm_property_type' => 'integer',
        'm_property_floors' => 'integer',
        'm_property_units_no' => 'integer',
        'm_property_elevators' => 'integer',
        'm_property_parking' => 'integer',
        'usage_type' => 'integer',
        'sublease' => 'integer',
        'rented_parking_no' => 'integer',
        'rent_period' => 'integer',
        'created_by' => 'integer',
        'active' => 'integer',
        'deleted' => 'integer'
