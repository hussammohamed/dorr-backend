...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_image_crop_upload__ = __webpack_require__(12);
...
Vue.component('login-component', __webpack_require__(24));
Vue.component('signup-component', __webpack_require__(27));
Vue.component('properties-component', __webpack_require__(30));
Vue.component('filters-component', __webpack_require__(33));
Vue.component('map-component', __webpack_require__(36));
Vue.component('addoffer-component', __webpack_require__(39));
Vue.component('offers-component', __webpack_require__(42));
Vue.component('report-component', __webpack_require__(43));
Vue.component('success-component', __webpack_require__(46));
Vue.component('mapview-component', __webpack_require__(49));
Vue.component('forgot-password-component', __webpack_require__(52));
var app = new Vue({
    el: '#app',
    data: function data() {
        return {
    ...
    methods: {
        ...
        mapDialog: function (_mapDialog) {
            ...
            mapDialog.showModal();
            setTimeout(function () {
                var lat = parseFloat(_this.$children[1]._props.propertylat);
                var long = parseFloat(_this.$children[1]._props.propertylong);
...
var update = __webpack_require__(16)("19b213fa", content, false, {});
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_language_js__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_mimes_js__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_data2blob_js__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_effectRipple_js__ = __webpack_require__(22);
//
//
//
//
        ...
        _vm._l(_vm.filteredSorted(_vm.properties), function(property) {
          return _c("div", { staticClass: "mdl-cell mdl-cell--12-col" }, [
            _c(
              "div",
              {
                staticClass: "card horizontal mdl-card mdl-shadow--2dp h-card "
              },
              [
                _c("a", {
                ...
                _c("div", { staticClass: "card-image" }, [
                  ...
                  property.pictures[0]
                    ? _c("img", {
                        attrs: { src: property.pictures[0].path, alt: "" }
                      })
                    : _c("img", {
                ...
                _c("div", { staticClass: "card-stacked" }, [
                  ...
                  _c("div", { staticClass: "card-footer" }, [
                    ...
                    _c("div", { staticClass: "footer-contet" }, [
                      _c("span", [_vm._v(_vm._s(property.details.bathrooms))]),
                      _vm._v(" "),
                      _c("img", {
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "filter-map owl-theme" },
    _vm._l(_vm.filters, function(filter) {
      return _c(
        "button",
        {
          staticClass:
            "item mdl-button mdl-js-button mdl-js-ripple-effect filter-map__button ",
...
var render = function() {
  ...
  return _c(
    "dialog",
    {
      staticClass: "mdl-dialog reportDialog dialog map-dialog",
      attrs: { id: "mapDialog" },
      on: { click: _vm.closeDialog }
    },
    [
