...
!function () {
  function e() {
    ...
    var t = e.querySelector("input"),
        ...
        l = e.querySelector(".mdl-js-menu");t.onkeydown = function (e) {
      38 != e.keyCode && 40 != e.keyCode || l.MaterialMenu.show();
    }, l.onkeydown = function (e) {
      13 == e.keyCode && t.focus();
    }, [].forEach.call(n, function (n) {
      n.onclick = function () {
        var a = n.textContent.trim();if (t.value = a, e.MaterialTextfield.change(a), setTimeout(function () {
          e.MaterialTextfield.updateClasses_();
        }, 250), t.dataset.val = n.dataset.val || "", "createEvent" in document) {
          var d = document.createEvent("HTMLEvents");d.initEvent("change", !1, !0), l.MaterialMenu.hide(), t.dispatchEvent(d);
        } else t.fireEvent("onchange");
      };
    });
  }, init: function init(e, t) {
    var n = document.querySelectorAll(e);[].forEach.call(n, function (e) {
      getmdlSelect._addEventListeners(e);var n = t || (e.querySelector(".mdl-menu").offsetWidth ? e.querySelector(".mdl-menu").offsetWidth : getmdlSelect._defaultValue.width);e.style.width = n + "px", componentHandler.upgradeElement(e), componentHandler.upgradeElement(e.querySelector("ul"));
    });
  } };
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(11), __webpack_require__(13).setImmediate))
    ...
    return _c(
      ...
      [
        ...
        _c("span", { staticClass: "mdl-textfield__error" }, [
          _vm._v("Input is not a number!")
        ]),
        _vm._v(" "),
        _c("span", { staticClass: "mdl-textfield__error server-error" })
      ]
    )
  },
  function() {
    ...
    return _c(
      ...
      [
        ...
        _c(
          "label",
          { staticClass: "mdl-textfield__label", attrs: { for: "password" } },
          [_vm._v("كلمة المرور")]
        )
      ]
    )
  ...
  function() {
    ...
    return _c(
      ...
      [
        ...
        _c(
          "label",
          { staticClass: "mdl-textfield__label", attrs: { for: "signupName" } },
          [_vm._v("أسم المستخدم")]
        )
      ]
    )
  ...
  function() {
    ...
    return _c(
      ...
      [
        _c("input", {
          staticClass: "mdl-textfield__input ",
          attrs: { type: "password", name: "password", id: "signupPassword" }
        }),
        _vm._v(" "),
        _c(
          "label",
